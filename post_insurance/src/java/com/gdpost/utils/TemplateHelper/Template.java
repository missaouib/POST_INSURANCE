...
public class Template {
	...
	public enum FileTemplate {Policy("承保清单", "QY"), /*PolicyDtl("承保业务信息清单", "QY"),*/ NewPolicyDtl("承保业务清单（新）", "QY"), UWDtlData("手工单时效数据", "QY"), 
		UnderWriteSentData("人核件打印数据", "QY"), PolicyBackDate("保单回单数据", "QY"), UnderWriteDtlData("总部人核件详细数据", "QY"), UnderWriteData("人核件登记数据", "QY"), UnderWriteRemark("市县人核件跟进数据", "QY"), UnderWriteInsured("被保险人身份数据", "QY"), DocNotScanDtl("未扫描档案明细", "QY"),
