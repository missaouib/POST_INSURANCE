...
public class Template {
	...
	public enum FileTemplate {Policy("承保清单", "QY"), PolicyDtl("承保业务信息清单", "QY"), PolicyUnderWrite("人核件回单数据", "QY"), Issue("问题件工单", "KF"), CallFail("回访不成功清单", "HF"), 
		...
		CallFailCityStatus("市县上门回访数据", "HF"), CallFailMiniCityStatus("市县回访详细数据", "HF"), CallFailCloseStatus("回访结案数据", "HF"), Renewed("续期应交清单", "XQ"), RenewedStatus("续期继续率清单", "XQ"), RenewedHQList("总部催收清单", "XQ"), 
