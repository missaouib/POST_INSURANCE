...
public class Template {
	...
	public enum FileTemplate {Policy("承保清单", "QY"), PolicyIngor("承保清单（略）", "QY"), PolicyDtl("承保业务信息清单", "QY"), PolicyUnderWrite("人核件回单数据", "QY"), UnderWriteSentData("人核件打印数据", "QY"), Issue("问题件工单", "KF"), CallFail("回访不成功清单", "HF"), 
