...
public class Template {
	...
	public enum FileTemplate {Policy("承保清单", "QY"), PolicyIngor("承保清单（略）", "QY"), PolicyDtl("承保业务信息清单", "QY"), PolicyBackDate("保单回单数据", "QY"), 
		UnderWriteSentData("人核件打印数据", "QY"), PolicyUnderWrite("人核件回单数据", "QY"), UnderWriteDtlData("总部人核件详细数据", "QY"), UnderWriteRemark("市县人核件跟进数据", "QY"), UnderWriteInsured("被保险人身份数据", "QY"), 
		...
		RenewedProvList("省分续期催收详情", "XQ"), RenewedFeeMatchList("余额匹配结果及省分催收数据", "XQ"), RenewedCityList("市县续期催收详情", "XQ"),
