...
public interface CheckDtlDAO extends JpaRepository<CheckModel, String>, JpaSpecificationExecutor<CheckModel> {
	...
	@Query(name="getCheckWriteStatDtl",
			...
			nativeQuery=true)
	List<CheckModel> getCheckWriteStatDtl(@Param("orgCode")String orgCode, @Param("pd1")String pd1, @Param("pd2")String pd2, @Param("duration")Integer duration, @Param("toPerm")String toPerm);
	...
	@Query(name="getCheckRecordStatDtl",
			value="select distinct it1.organ_code, it1.organ_name," + 
					...
					"and it1.attached_flag=0;",
			nativeQuery=true)
	List<CheckModel> getCheckRecordStatDtl(@Param("orgCode")String orgCode, @Param("pd1")String pd1, @Param("pd2")String pd2, @Param("duration")Integer duration, @Param("toPerm")String toPerm);
