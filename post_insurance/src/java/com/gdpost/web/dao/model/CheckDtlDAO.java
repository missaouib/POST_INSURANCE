...
public interface CheckDtlDAO extends JpaRepository<CheckModel, String>, JpaSpecificationExecutor<CheckModel> {
	...
	@Query(name="getCheckModelWriteStatDtl",
			value="select distinct t1.policy_no as policy_no, it1.organ_code as organ_code, it1.organ_name as organ_name, " + 
					"iit2.check_batch as check_batch,it2.need_fix as need_fix,it2.key_info as key_info,"
