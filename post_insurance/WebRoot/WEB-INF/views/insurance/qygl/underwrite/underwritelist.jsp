	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li class="line">line</li>
				<li><a class="edit" target="dialog" rel="underwrite_edit" mask="true" width="850" height="580" href="${contextPath }/qygl/underwrite/update/{slt_uid}"><span>更新人核件</span></a></li>
			...
			<li class="line">line</li>
				<li><a class="edit" target="dialog" rel="underwrite_edit" mask="true" width="850" height="620" href="${contextPath }/qygl/underwrite/create"><span>新建人核件</span></a></li>
				<li><a class="delete" href="${contextPath}/qygl/underwrite/provSend/{slt_uid}" target="dialog" mask="true" width="550" height="250"><span>省分寄出</span></a></li>
			</shiro:hasPermission>
