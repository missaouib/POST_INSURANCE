	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="Underwrite:view">
				<li><a iconClass="user_edit" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="680" href="${contextPath }/qygl/view/{slt_uid}"><span>增加人核件</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="Underwrite:edit">
				<li><a iconClass="user_edit" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="520" href="${contextPath }/qygl/update/{slt_uid}"><span>寄出登记</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="Underwrite:edit">
				<li><a iconClass="user_edit" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="520" href="${contextPath }/qygl/update/{slt_uid}"><span>收到登记</span></a></li>
			</shiro:hasPermission>
		</ul>
	</div>
