...
<dwz:paginationForm action="${contextPath }/qygl/uwlist2weixin" page="${page }">
</dwz:paginationForm>

<form method="post" id="hfForm" action="${contextPath }/qygl/uwlist2weixin" onsubmit="return navTabSearch(this)">
