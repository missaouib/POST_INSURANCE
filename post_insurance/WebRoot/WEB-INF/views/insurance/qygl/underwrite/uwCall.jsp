...
<dwz:paginationForm action="${contextPath }/qygl/uwlist2call" page="${page }">
</dwz:paginationForm>

<form method="post" id="hfForm" action="${contextPath }/qygl/uwlist2call" onsubmit="return navTabSearch(this)">
