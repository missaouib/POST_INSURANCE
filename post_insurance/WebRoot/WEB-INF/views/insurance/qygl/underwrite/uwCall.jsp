...
<dwz:paginationForm action="${contextPath }/qygl/uwlist2call" page="${page }" onsubmit="return dwzSearch(this, 'dialog');">
</dwz:paginationForm>

<form method="post" id="hfForm" action="${contextPath }/qygl/uwlist2call" onsubmit="return dwzSearch(this, 'dialog');">
