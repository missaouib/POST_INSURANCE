...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<%-- <shiro:hasPermission name="CheckRecord:save">
				<li><a iconClass="user_add" target="dialog" rel="lookup2organization_add" mask="true" width="530" height="330" href="${contextPath }/qygl/issue/record/create"><span>添加问题工单</span></a></li>
			</shiro:hasPermission> --%>
			<shiro:hasPermission name="CheckRecord:view">
				<li><a iconClass="user_edit" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="680" href="${contextPath }/qygl/issue/record/view/{slt_uid}"><span>查看问题工单</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="CheckRecord:edit">
				<li><a iconClass="user_edit" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="520" href="${contextPath }/qygl/issue/record/update/{slt_uid}"><span>回复问题工单</span></a></li>
			</shiro:hasPermission>
			<%-- <shiro:hasPermission name="CheckRecord:delete">
				<li><a iconClass="user_delete" target="selectedTodo" rel="ids" href="${contextPath }/qygl/issue/record/list/delete" title="确认要删除?"><span>删除问题工单</span></a></li>
			</shiro:hasPermission> --%>
		</ul>
	</div>
