	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="CheckWrite:provEdit">
				...
				<li><a class="edit" target="ajaxTodo" href="${contextPath }/qygl/issue/write/fail/{slt_uid}" title="确认无法整改?"><span>无法整改</span></a></li>
				<li><a class="edit" target="selectedTodo" rel="ids" href="${contextPath }/qygl/issue/write/isTruth" title="确定翻转客真标记?"><span>修改客真标志</span></a></li>
			</shiro:hasPermission>
