...
<form method="post" id="issueForm" action="${contextPath}/kfgl/issue/reopenCheckWrite" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
