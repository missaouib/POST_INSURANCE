...
<dwz:paginationForm action="${contextPath }/qygl/issue/reuse/issuelist" page="${page }">
</dwz:paginationForm>

<form method="post" action="${contextPath }/qygl/issue/reuse/issuelist" onsubmit="return navTabSearch(this)">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="CheckWrite:view">
				<li><a iconClass="magnifier" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="680" href="${contextPath }/qygl/issue/reuse/view/{slt_uid}"><span>查看新契约客真信息重复件</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="CheckWrite:edit">
				<li><a class="edit" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="520" href="${contextPath }/qygl/issue/reuse/update/{slt_uid}"><span>回复新契约客真信息重复件</span></a></li>
			</shiro:hasPermission>
		</ul>
	</div>
