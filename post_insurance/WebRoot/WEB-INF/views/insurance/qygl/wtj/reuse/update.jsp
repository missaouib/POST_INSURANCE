...
<form method="post" action="${contextPath}/qygl/issue/reuseRisk/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<input type="hidden" name="id" value="${issue.id}"/>
	<input type="hidden" id="fixTypeVal" name="fixTypeVal" value=""/>
	<div class="pageFormContent" layoutH="58">
	<fieldset>
		<legend>新契约客真信息重复件基本信息</legend>
		<p>
			<label>保单号：</label>
