...
<form method="post" id="hfForm" action="${contextPath }/component/stastics/statusStat" onsubmit="return navTabSearch(this)">
...
<div class="row" style="padding: 0 3px;">
	...
	<h2 class="contentTitle">列表展示（单位：件）注： &nbsp;&nbsp;&nbsp;&nbsp;</h2>
		...
		<tbody>
			...
			<tr>
				...
				<td style="text-align: right;"><fmt:formatNumber value="${(1-item.errCounts/item.checkCounts)*100}" pattern="#,###.##" />%</td>
			</tr>
			</c:forEach>
			<tr>
				<td>&nbsp;</td>
	...
	<div id="statustatMain" style="width: 800px;height:500px;"></div>
	    <script type="text/javascript">
	        // 基于准备好的dom，初始化echarts实例
	        var myChart = echarts.init(document.getElementById('statustatMain'));
