...
<form method="post" action="${contextPath}/basedata/checkFixType/update" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
