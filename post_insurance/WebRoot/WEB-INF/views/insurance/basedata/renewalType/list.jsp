	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="RenewalType:save">
				<li><a class="add" target="dialog" rel="lookup2organization_add" mask="true" width="530" height="330" href="${contextPath }/basedata/renewalType/create"><span>添加续期催收类型</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="RenewalType:edit">
				<li><a class="edit" target="dialog" rel="lookup2organization_edit" mask="true" width="530" height="330" href="${contextPath }/basedata/renewalType/update/{slt_uid}"><span>编辑续期催收类型</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="RenewalType:delete">
				<li><a class="delete" target="selectedTodo" rel="ids" href="${contextPath }/basedata/renewalType/delete" title="确认要删除?"><span>删除续期催收类型</span></a></li>
			</shiro:hasPermission>
		</ul>
	</div>
