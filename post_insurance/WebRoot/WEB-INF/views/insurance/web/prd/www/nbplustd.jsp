...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FF3300">
  <tr>
    ...
    <td width="81%" colspan="2" bgcolor="#FFFFFF">中邮年年好健康保障计划（定制版），注意主险和附加险名称的填写。<br>
      （邮保通产品代码：<br>
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFFF">需要正确使用<strong class="my">年年好重疾保障计划投保书，可用2016版。</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td rowspan="14" bgcolor="#FFFFFF">填单要点</td>
  ...
  <tr>
    <td colspan="2" bgcolor="#FFFFFF">份数：主附险均1份起售 每份1000元、附加险每份10元。</td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#FFFFFF"><p>交费期间：3年交、5年交 <br>
      保险期间：15年、20年、保至70周岁</p></td>
  </tr>
  <tr>
    <td rowspan="3" bgcolor="#FFFFFF">保费比例</td>
    <td bgcolor="#FFFFFF"><p>3年交保15/20年	<br>
      主附险比例≤1:50（即一份主险最多<strong>50</strong>份附加险）</p></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">5年交保15/20年<br>
      主附险比例≤1:30（即一份主险最多<strong>30</strong>份附加险）</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">3/5年交保至70周岁<br>
