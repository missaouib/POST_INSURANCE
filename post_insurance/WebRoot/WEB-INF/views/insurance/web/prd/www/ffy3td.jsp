...
<div data-role="collapsible">
  <h3>填单要点</h3>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FF6600">
  <tr>
    <td width="19%" bgcolor="#FFFFFF">险种名称</td>
    <td width="81%" bgcolor="#FFFFFF"><strong class="my">中邮富富余3号两全保险（分红型）</strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">投保单</td>
    <td bgcolor="#FFFFFF">必须正确使用<strong><span class="my">富富余3号号投保书</span></strong>，<span class="myred"><strong>条款</strong></span>为独立印刷单独一本。<br>
      <strong>如选购附加险，必须使用2016版投保单。</strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">20万或以上大额件</td>
    <td bgcolor="#FFFFFF">大额件必须留出客户身份证复印件，卡折复印件，如果被保险人非投保人本人需要关系证明，如指定受益人，也需关系证明。（反洗钱要求，与省分行稽核要求一致）</td>
  </tr>
  <tr>
    <td rowspan="13" bgcolor="#FFFFFF">填单要点</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><span class="myred">注：60周岁以上客户期交或65周岁以上客户趸交需要走人工核保，邮保通限制承保出单。<br>
      <strong>广东：60周岁或以上必须进行录音录像且转人工核保。</strong>    </span></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">险种名称可以直接填写：<strong class="my">富富余1号</strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><strong>附加险</strong>：如交费方式为<strong><span class="my">年交</span></strong>时，<strong><span class="myred">可附加：附加意外伤害医疗</span></strong><br>
附加意外医疗伤害附加险以保险金额销售，必须使用2016版投保单，<span class="my"><strong>份数处填写保险金额</strong></span>，最低1000元，最高不能超过首期保费且为1000的整数倍，且最高不超过20000元。<br>
<strong>每1000元基本保险金额保险费为10元。</strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><span class="my"><strong>职业请填写最高类别的职业</strong>，</span>如建筑水电工（室内），职业代码为：0701015</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">基本保险金额可以不用填写。</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">份数：2份起售 每份500元</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">交费期间：趸交（一次性交清）、3年交、6年交<br>
      <span class="my"><strong>更新承保规则：</strong></span><br>
      趸交或3年交时：出生满30天至70周岁<br>
      <strong>6年交时：出生满30天至50周岁 </strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">保险期间：6年</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">告知事项在投保单背面，由投保人阅读告知事项并<strong>亲自</strong>在告知栏勾选实际情况</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><strong class="my">投保人抄录语句项必须由投保人亲笔抄写</strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">投保人与被保险人分别需要<strong>本人亲笔签名</strong>，不得由他人代签名</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">如被保险人为<strong><span class="myred">未成年人</span></strong>（未满18岁），被保险人签名处由其<span class="myred"><strong>监护人</strong></span>（如父母）亲笔签名（监护人姓名）</td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#FFFFFF"><strong>备注：</strong>未成年人保额限制根据保监会规定。</td>
  </tr>
</table>
</div>
<div data-role="collapsible">
        ...
        <div data-role="collapsible">
            ...
            <p>
                <li>共6项：<br><strong class="my"><span class="myred">1、投保单（公司联）（2011版或2016版，如带附加险必须2016版）；<br>2、投保提示书；<br>
