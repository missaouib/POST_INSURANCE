...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#ff6600">
  <tr>
    <td width="11%" rowspan="3" bgcolor="#FFFFFF">产品特色</td>
    <td width="89%" bgcolor="#FFFFFF"><span class="my"><strong>（一）保障好</strong></span><strong><br>
...
&nbsp;&nbsp;&nbsp; <strong>持续保证</strong>：如发生重疾责任赔付，主险责任继续有效。</td>
  ...
  <tr>
    <td bgcolor="#FFFFFF"><span class="my"><strong>（二）定制好</strong></span><strong><br>
...
&nbsp;&nbsp;&nbsp;<strong>理财定制</strong>：您可选择适量附加险与主险搭配，定制偏理财功能组合，做好长期理财规划。</td>
  ...
  <tr>
    <td bgcolor="#FFFFFF"><span class="my"><strong>（二）保底好</strong></span><strong><br>
