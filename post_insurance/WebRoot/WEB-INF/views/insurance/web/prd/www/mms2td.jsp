...
<div data-role="collapsible">
  <h3>填单要点<strong><span class="myred">（本产品已停售）</span></strong></h3>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FF6600">
  <tr>
    <td width="19%" bgcolor="#FFFFFF">险种名称</td>
    <td width="81%" bgcolor="#FFFFFF"><strong class="my">中邮绵绵寿2号年金保险（分红型）</strong><strong><span class="myred">（本产品已停售）</span></strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">投保单</td>
    <td bgcolor="#FFFFFF">必须正确使用<strong><span class="my">绵绵寿2号投保书</span></strong>，<span class="myred"><strong>条款</strong></span>为独立印刷单独一本。</td>
  </tr>
  <tr>
  ...
  <tr>
    <td rowspan="12" bgcolor="#FFFFFF">填单要点</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><span class="myred">注：60周岁以上客户作为投保人需要走人工核保，邮保通限制承保出单。<br>
      <strong>广东：60周岁或以上必须进行录音录像且转人工核保。</strong>    </span></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">险种名称可以填写：<strong class="my">绵绵寿2号</strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><strong class="my">职业请填写最高类别的职业</strong>，如建筑水电工（室内），职业代码为：0701015</td>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="#FFFFFF">交费期间：5年交、10年交</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">保险期间：15年</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">告知事项在投保单背面，由投保人阅读告知事项并<strong class="myred">亲自</strong>在告知栏勾选实际情况</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><strong class="my">投保人抄录语句项必须由投保人亲笔抄写</strong></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">投保人与被保险人需要<strong class="myred">本人亲笔签名</strong>，不得由他人代签名</td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">如被保险人为<span class="myred"><strong>未成年人</strong></span>（未满18岁），被保险人签名处由其<span class="myred"><strong>监护人</strong></span>（如父母）<span class="myred"><strong>亲笔签名</strong></span>（监护人姓名）</td>
  </tr>
</table>
</div>
<div data-role="collapsible">
            ...
            <p>
                <li>共七项：<br>
                  ...
                  2、投保单（客户联）（2011版或2016版）；<br>3、投保提示书（投保书附带的那份）；<br>
                  4、产品说明+保险条款；<br>5、收费凭证；<br>
