	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="Wtgd:view">
				...
				<li class="line">line</li>
				<li><a class="icon" onclick="javascript:urlCheckOverDate(183, $('#kfBBDDate1').val(),$('#kfBBDDate2').val(),'${contextPath }/kfgl/toXls?search_LIKE_issueNo=${param.search_LIKE_issueNo }&orgCode=${orgCode }&search_LTE_readyDate=${param.search_LTE_readyDate }&search_GTE_readyDate=${param.search_GTE_readyDate }&search_LTE_billBackDate=${param.search_LTE_billBackDate }&search_GTE_billBackDate=${param.search_GTE_billBackDate }&search_LIKE_policy.policyNo=${search_LIKE_policy_policyNo }&status=${eStatus }&issueType=${issueType}&kfstatus_flag=${kfstatus_flag}');"><span>导出Excel</span></a></li>
			</shiro:hasPermission>
			<li class="line">line</li>
