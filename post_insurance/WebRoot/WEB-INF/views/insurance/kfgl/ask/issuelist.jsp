...
<form method="post" action="${contextPath }/kfgl/inquire/list" onsubmit="return navTabSearch(this)">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="Wtgd:view">
				<li><a iconClass="magnifier" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="680" href="${contextPath }/kfgl/inquire/view/{slt_uid}"><span>查看问题工单</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="Wtgd:edit">
				<li><a class="edit" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="520" href="${contextPath }/kfgl/inquire/update/{slt_uid}"><span>回复问题工单</span></a></li>
			</shiro:hasPermission>
		</ul>
	</div>
