...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="Renewed:view">
				<li><a iconClass="magnifier" target="dialog" rel="lookup2organization_edit" mask="true" width="850" height="580" href="${contextPath }/xqgl/issue/view/{slt_uid}"><span>查看详情</span></a></li>
			</shiro:hasPermission>
	...
	<table class="table" layoutH="185" width="130%">
		<thead>
			<tr>
