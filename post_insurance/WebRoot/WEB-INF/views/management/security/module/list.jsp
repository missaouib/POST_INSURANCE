...
<div class="pageContent">
	<div class="panelBar">
		...
		<shiro:hasPermission name="Module:view">
			<li><a iconClass="magnifier" target="dialog" width="540" height="560" mask="true" href="${contextPath }/management/security/module/view/${parentModuleId}"><span>查看模块</span></a></li>
		</shiro:hasPermission>		
		...
		<shiro:hasPermission name="Module:edit">
			<li><a iconClass="application_edit" target="dialog" rel="lookupParent2module_edit" width="540" height="560" mask="true" href="${contextPath }/management/security/module/update/${parentModuleId}"><span>编辑模块</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="Module:delete">
			<li><a iconClass="application_delete" target="ajaxTodo" callback="dialogReloadRel2Module" href="${contextPath }/management/security/module/delete/${parentModuleId}" title="确认要删除该模块?"><span>删除模块</span></a></li>
		</shiro:hasPermission>
		</ul>
	</div>
