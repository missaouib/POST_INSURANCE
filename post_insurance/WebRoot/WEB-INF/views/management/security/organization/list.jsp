...
<div class="pageContent">
	<div class="panelBar">
		...
		<shiro:hasPermission name="Organization:edit">
			<li><a iconClass="group_edit" target="dialog" mask="true" rel="lookupParent2org_edit" width="530" height="260" href="${contextPath}/management/security/organization/update/${parentOrganizationId}"><span>编辑组织</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="Organization:delete">
			<li><a iconClass="group_delete" target="ajaxTodo" callback="dialogReloadRel2Org" href="${contextPath}/management/security/organization/delete/${parentOrganizationId}" title="确认要删除该组织?"><span>删除组织</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="Organization:assign">
			<li class="line">line</li>
			<li><a iconClass="shield_add" target="dialog" mask="true" width="400" height="500" href="${contextPath}/management/security/organization/lookup2create/organizationRole/${parentOrganizationId}"><span>分配角色</span></a></li>
			<li><a iconClass="shield_delete" target="dialog" mask="true" width="400" height="500" href="${contextPath}/management/security/organization/lookup2delete/organizationRole/${parentOrganizationId}"><span>撤销角色</span></a></li>
		</shiro:hasPermission>		
		</ul>
	</div>
