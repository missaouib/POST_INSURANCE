...
$(document).ready(function(){
	doRefresh();
	//checkMessage();
	window.setInterval("checkMessage()",60 * 3 * 60 * 1000);//1分钟刷新1次
	window.setInterval("checkUrge()",10 * 60 * 1000);//1分钟刷新1次 
}); 
</script>
</head>
<body scroll="no">
...
<div id="footer">中邮保险广东分公司 运营管理部 Copyright &copy; 2013-2020, All Rights Reserve.</div>
