...
<form method="post" action="${contextPath }/uploaddatamanage/templatefieldrule/create/${rule.tblMemberDataTemplateField.id}" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogReloadNavTab);">
	<div class="pageFormContent" layoutH="58">
		...
		<p>
			<label>规则名称：</label>
			<input type="text" name="ruleName" class="input-medium validate[required,maxSize[32]] required" maxlength="32" />
		</p>
		<p>
			<label>分割符</label>
			<input type="text" name="splitChar" class="input-medium validate[required,maxSize[32]] required" maxlength="32" />
		</p>
		<p>
			<label>取值序号：</label>
			<input type="text" name="valueIndex" class="input-medium validate[required,custom[onlyNumberSp]] required" maxlength="2" />
		</p>				
	</div>
	<div class="formBar">
		<ul>
